...
file_name = os.path.abspath(os.path.dirname(os.getcwd()) + '/Image/test001.png')
    ...
    def tearDown(self):
        ...
        for method_name, error in self._outcome.errors:
            if error:
                ...
                file_path = os.path.abspath(dir_path + "/report/" + case_name + ".png")
                self.driver.save_screenshot(file_path)  # 失败截图
        # print("这个是case的后置调键1")
        self.driver.close()
...
if __name__ == '__main__':
    file_path = os.path.abspath(os.getcwd() + "/report/" + "first_case1.html")
    f = open(file_path, 'wb')
